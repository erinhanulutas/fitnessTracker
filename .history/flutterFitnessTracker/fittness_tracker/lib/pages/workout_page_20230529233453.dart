            ...
            if (snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ExerciseTile(exerciseName: exs[index].name, weight: exs[index].weight.toString(), reps: exs[index].reps.toString(), sets: exs[index].sets.toString(), isComplete: exs[index].isCompleted)
                },
              );
            } else {
