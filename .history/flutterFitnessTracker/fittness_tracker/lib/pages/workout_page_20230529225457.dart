    ...
    return Scaffold(
        ...
        body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            List<Exercise> exs = List.empty();
            snapshot.data!.map((exercise) {exs.add(Exercise.fromJson(exercise))});
            if (snapshot.connectionState == ConnectionState.done) {
              return ExerciseTile(exerciseName: exerciseName, weight: weight, reps: reps, sets: sets, isComplete: isComplete)
            } else {
